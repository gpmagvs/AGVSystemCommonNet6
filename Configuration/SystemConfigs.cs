...
namespace AGVSystemCommonNet6.Configuration
{
    public class SystemConfigs
    {
        ...
        public string DBConnection { get; set; } = "Server=127.0.0.1;Database=GPMAGVs;User Id=sa;Password=12345678;Encrypt=False;MultipleActiveResultSets=True;Connection Lifetime=1;Min Pool Size=5;Max Pool Size=250;MultipleActiveResultSets=True;";
        public string WarRoomDBConnection { get; set; } = "Server=127.0.0.1;Database=3FSE;User Id=sa;Password=12345678;Encrypt=False;MultipleActiveResultSets=True;Connection Lifetime=1;Min Pool Size=5;Max Pool Size=50;";
