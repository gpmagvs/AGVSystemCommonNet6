...
namespace AGVSystemCommonNet6.Log
{
    public class LOG
    {
        ...
        {
            _logger.Log(new LogItem(LogLevel.Trace, info, show_console, color, NewLogFileEndStr), caller_class_name);
        }
        ...
        {
            var caller_class_name = new StackTrace().GetFrame(1).GetMethod().DeclaringType.Name; ;
            _logger.Log(new LogItem(LogLevel.Information, info, show_console, color, NewLogFileEndStr), caller_class_name);
        }

        public static void WARN(string info, bool show_console = true, ConsoleColor color = ConsoleColor.White, string NewLogFileEndStr = "")
        {
            var caller_class_name = new StackTrace().GetFrame(1).GetMethod().DeclaringType.Name; ;
            _logger.Log(new LogItem(LogLevel.Warning, info, show_console, color, NewLogFileEndStr), caller_class_name);
        }
        public static void ERROR(string info, Exception ex, bool show_console = true, ConsoleColor color = ConsoleColor.White, string NewLogFileEndStr = "")
        {
            ...
            _logger.Log(new LogItem(LogLevel.Error, msg, show_console, color, NewLogFileEndStr) { exception = ex }, caller_class_name);
        }
        ...
        {
            var caller_class_name = new StackTrace().GetFrame(1).GetMethod().DeclaringType.Name; ;
            _logger.Log(new LogItem(LogLevel.Error, string.Format("{0}", info, show_console, color, NewLogFileEndStr)), caller_class_name);
        }
        ...
        public static void Critical(string msg, Exception ex, bool show_console = true, ConsoleColor color = ConsoleColor.White, string NewLogFileEndStr = "")
        {
            ...
            _logger.Log(new LogItem(LogLevel.Critical, _msg, show_console, color, NewLogFileEndStr) { exception = ex }, caller_class_name);
        }
        ...
        {
            var caller_class_name = new StackTrace().GetFrame(1).GetMethod().DeclaringType.Name; ;
            _logger.Log(new LogItem(LogLevel.Critical, info, show_console, color, NewLogFileEndStr), caller_class_name);
        }
