namespace AGVSystemCommonNet6.Vehicle_Control.VCS_ALARM
{
    public enum AlarmCodes
    {
        ...
        Handshake_Timeout_TA2_EQ_READY_Not_On = 3211,
        Handshake_Timeout_TA3_EQ_BUSY_Not_ON = 3212,
        Handshake_Timeout_TA5_EQ_READY_Not_OFF = 3213,
        Handshake_Timeout_TA1_EQ_L_REQ_Not_On = 3214,
        Handshake_Timeout_TA1_EQ_U_REQ_Not_On = 3215,
        Handshake_Timeout_TA4_EQ_BUSY_Not_OFF = 3216,
        Handshake_Timeout_TA5_EQ_L_REQ_Not_OFF = 3217,
        Handshake_Timeout_TA5_EQ_U_REQ_Not_OFF = 3218,
        Handshake_Fail_AGV_DOWN = 3219,
        ...
        Handshake_Fail_EQ_Busy_ON_When_AGV_BUSY = 3231,
        Handshake_Fail_EQ_LU_REQ_OFF_WHEN_WAIT_READY = 3232,
        Handshake_Fail_BAT_EXG_EQ_BUSY_NOT_ON = 3235,
        Handshake_Fail_BAT_EXG_EQ_BUSY_NOT_OFF = 3236,
        Handshake_Fail_BAT_EXG_EQ_VALID_NOT_ON = 3280,
        Handshake_Fail_BAT_EXG_EQ_VALID_NOT_OFF,
        ...
        Handshake_Fail_BAT_EXG_EQ_Check_Result_NOT_ON,
        Handshake_Fail_BAT_EXG_EQ_Check_Result_NOT_OFF,
        Handshake_Fail_BAT_EXG_EQ_Check_Ready_NOT_ON,
        ...
        Code_Error_In_System = 10011,
        Subscribe_ROS_Topic_Err = 10012,
        ROS_Bridge_server_Disconnect = 10013,
        AGV_Pose_Angle_Not_Match_To_Sick_Angle = 10014,
        USER_Press_SoftwareEMO_But_Exception_Occur = 10015,
        EQP_LOAD_BUT_EQP_HAS_OBSTACLE = 10016,
        EQP_UNLOAD_BUT_EQP_HAS_NO_CARGO = 10017,
        Cant_Change_Online_Mode_Code_Error = 10018,
        Cant_TransferTask_TO_AGVC = 10019,
        Motion_control_Wrong_Unknown_Code = 10020,
        UserAbort_Initialize_Process = 10021,
        Sick_Lidar_Communication_Error = 10022,
        Fork_WorkStation_Teach_Data_Not_Found_Tag = 10023,
        Fork_WorkStation_Teach_Data_Not_Found_layer = 10024,
        Fork_Arm_Pose_Error = 10025,
        Destine_Point_Is_Virtual_Point = 10026,
        Fork_Frontend_has_Obstacle = 10027,
        Fork_Has_Cargo_But_Initialize_Running = 10028,
        Fork_Disabled = 10029,
        AGV_Cant_Goto_Workstation_When_Fork_Is_Disabled = 10030,
        Fork_Initialize_Process_Interupt = 10031,
        Fork_Initialize_Process_Error_Occur = 10032,
        Fork_Initialized_But_Home_Input_Not_ON = 10033,
        Fork_Go_Home_But_Home_Sensor_Signal_Error = 10034,
        Fork_Initialized_But_Driver_Position_Not_ZERO = 10035,
        Laser_Mode_Switch_Fail_DO_Write_Fail = 10036,
        Laser_Mode_Switch_Fail_Exception = 10037,
        Laser_Mode_Switch_Fail_Timeout = 10038,
        Laser_Mode_Switch_But_SICK_OUPUT_NOT_UPDATE = 10039,
        Localization_Fail = 10040,
        Measure_Result_Data_Report_Fail = 10041,
        Exception_When_AGVC_AGVS_Task_Reset_Abort = 10042,
        Exception_When_AGVC_AGVS_Task_Reset_CycleStop = 10043,
        GetVirtualIDFail = 10044,
        AGV_BarcodeReader_Not_Match_Tag_of_Destination = 10045,
        AGV_Park_Position_Too_Far_From_Tag_Of_Destination = 10046,
        Fork_Arm_Action_Timeout = 10047,
        Fork_Arm_Action_Error = 10048,
        Replan = 10049,
        Limit_Switch_Sensor = 10050,
        Send_Goal_to_AGV_But_AGVS_Cancel_Req_Raised = 10051,
        Fork_Slot_Teach_Data_ERROR = 10052,
        Battery_Low_Level_Auto_PC_Shutdown = 10053,
